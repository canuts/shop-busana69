                ...
                <tr>
                    <td>
                        <table align="center" border="0" cellpadding="0" cellspacing="0" >
                            <tr>
                                <td>
                                    <img src="img/complete/delivery.png" alt="" style=";margin-bottom: 30px;">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <img src="img/complete/success.png" alt="">
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <img src="img/complete/order-success.png" alt="" style="margin-top: 30px;">
                                </td>
                            </tr>
                        </table>
                        ...
                        <table class="order-detail" border="0" cellpadding="0" cellspacing="0"  align="left">
                            ...
                            <tr>                                
                                <td>
                                    <img src="img/complete/13.jpg" alt="" width="70">
                                </td>
                            ...
                            <tr>                                
                                <td>
                                    <img src="img/complete/14.jpg" alt="" width="70">
                                </td>
                                <td valign="top" style="padding-left: 15px;">
                                    <h5 style="margin-top: 15px;">Three seater Wood Style sofa for Leavingroom </h5>
                                </td>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" align="left" style="width: 100%;margin-top: 30px;    margin-bottom: 30px;">
                                    <tbody><tr>
                                        ...
                                        <td width="57" height="25" class="user-info"><img src="img/complete/space.jpg" alt=" " height="25" width="57"></td>
                            ...
                            <tr>
                                <td style="padding: 30px;">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="footer-social-icon" align="center" class="text-center" style="margin-top:20px;">
                                        <tr>
                                            <td>
                                                <a href="#"><img src="img/complete/facebook.png" alt=""></a>
                                            </td>
                                            <td>
                                                <a href="#"><img src="img/complete/youtube.png" alt=""></a>
                                            </td>
                                            <td>
                                                <a href="#"><img src="img/complete/twitter.png" alt=""></a>
                                            </td>
                                            <td>
                                                <a href="#"><img src="img/complete/gplus.png" alt=""></a>
                                            </td>
                                            <td>
                                                <a href="#"><img src="img/complete/linkedin.png" alt=""></a>
                                            </td>
                                            <td>
                                                <a href="#"><img src="img/complete/pinterest.png" alt=""></a>
                                            </td>
                                        </tr>                                    
                                    </table>
