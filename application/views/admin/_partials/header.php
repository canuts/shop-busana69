...
<head>
  ...
  <title>Admin - <?= set('nama_site'); ?></title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Admin Busana69</span>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          ...
          <a href="#" class="d-block">Canuts Bastrad</a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
              ...
              <li class="nav-item has-treeview">
                ...
                <a href="<?= base_url('request-payment') ?>" class="nav-link">
              ...
              <li class="nav-item has-treeview">
                ...
                <a href="<?= base_url('get_kategori') ?>" class="nav-link">

                  <i class="nav-icon fas fa-tachometer-alt"></i>

                  <p>Kategori & Subkategori</p>
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item has-treeview">
                ...
                <a href="<?= base_url() ?>all_produk" class="nav-link">
              ...
              <li class="nav-item has-treeview">
                ...
                <a href="#add-produk" data-toggle="modal" class="nav-link">
          ...
          <li class="nav-item has-treeview">
                ...
                <a href="<?= base_url('ulasan') ?>" class="nav-link">
